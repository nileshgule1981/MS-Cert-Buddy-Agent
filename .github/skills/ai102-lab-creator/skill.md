---
name: ai102-lab-creator
description: Create short AI-102 practice labs (10-20 minutes) that are executable and self-validating. Every lab includes prerequisites, exact tasks, validation steps, expected outputs, and cleanup. Use Azure MCP to validate feasibility (commands, resource types, properties, and outcomes).
---

# Skill: ai102.practice_labs.micro.validated
...
- Keep the lab within AI-102 scope (AI solution design and implementation tasks).
...
1. Choose a single AI-102 objective and state it at the top.
...
```yaml
lab:
  title: "<Action + resource, e.g., 'Deploy a custom vision model for image classification'>"
  objective: "<One sentence outcome tied to AI-102>"
  skill_area: "<AI-102 skill area>"
...
```text
Create {{count}} AI-102 micro-labs.

Inputs:

- skill_area: {{skill_area}} (or select from AI-102 study guide)
